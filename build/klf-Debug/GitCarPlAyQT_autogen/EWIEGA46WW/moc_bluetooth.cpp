...
template <> constexpr inline auto Bluetooth::qt_create_metaobjectdata<qt_meta_tag_ZN9BluetoothE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'deviceFound'
        QtMocHelpers::SlotData<void(const QBluetoothDeviceInfo &)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'scanFinished'
...
void Bluetooth::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->deviceFound((*reinterpret_cast<std::add_pointer_t<QBluetoothDeviceInfo>>(_a[1]))); break;
